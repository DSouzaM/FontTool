...
class all():
    ...
    class NPUSHB_Statement(PUSH_Statement):
        def __init__(self):
            root_statement.__init__(self)
            self.push_num = len(self.data)
            self.pop_num = 0
            self.mnemonic = 'NPUSHB'
    ...
    class NPUSHW_Statement(PUSH_Statement):
        def __init__(self):
            root_statement.__init__(self)
            self.push_num = len(self.data)
            self.pop_num = 0
            self.mnemonic = 'NPUSHW'
    ...
    class IF_Statement(root_statement):
        def __init__(self):
            ...
            self.reverse = False
            self.stored_environments = None
            self.already_seen_insts = None
            self.ignored_insts = None
            self.bytecode2ir = None
